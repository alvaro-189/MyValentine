...
var loveData = [
  ...
  { text: "Juguetona", time: 51 },
  { text: "Eres extrovertida", time: 52 },
  { text: "Tu belleza natural", time: 53 },
  { text: "Tu risa", time: 54 },
  { text: "Tu amor por tus amigos", time: 55 },
  { text: "Tu humildad", time: 56 },
  { text: "Tu lado juguetón", time: 57 },
  { text: "Recuerdas nuestros buenos momentos", time: 58 },
  { text: "Tu tacto", time: 59 },
  { text: "Tu gusto por la música que nos une", time: 60 },
  { text: "Tu confiabilidad", time: 61 },
  { text: "Tu comprensión", time: 62 },
  { text: "Tu dedicación a tus metas", time: 63 },
  { text: "Tu pasión por lo que amas", time: 64 },
  { text: "Tu calidez", time: 65 },
  { text: "Tus cumplidos", time: 66 },
  { text: "Tus pequeños chistes", time: 67 },
  { text: "Tu respeto", time: 68 },
  { text: "Tu encanto", time: 69 },
  { text: "Tu gracia", time: 70 },
  { text: "Tu confianza", time: 71 },
  { text: "Tu atención", time: 72 },
  { text: "Tus creencias", time: 73 },
  { text: "No me juzgas", time: 74 },
  { text: "Nuestra conexión", time: 75 },
  { text: "Nuestro vínculo", time: 76 },
  { text: "Tu timidez", time: 77 },
  { text: "Tu curiosidad", time: 78 },
  { text: "Tu respeto por ti misma", time: 79 },
  { text: "Tu cuidado personal", time: 80 },
  { text: "Tu crecimiento", time: 81 },
  { text: "Tu apego", time: 82 },
  { text: "Tu esfuerzo", time: 83 },
  { text: "Me haces sentir cálido", time: 84 },
  { text: "Tus besos", time: 85 },
  { text: "Tu piel", time: 86 },
  { text: "Tu voluntad", time: 87 },
  { text: "Tus chistes", time: 88 },
  { text: "Tu familia", time: 89 },
  { text: "Tus defectos", time: 90 },
  { text: "Tu madurez", time: 91 },
  { text: "Tu responsabilidad", time: 92 },
  { text: "Tus dientes", time: 93 },
  { text: "Tus consejos", time: 94 },
  { text: "Tus modales", time: 95 },
  { text: "Tu seriedad", time: 96 },
  { text: "Tu amor", time: 97 },
  { text: "Eres Linda", time: 98 },
  { text: "Me hiciste ser una mejor persona", time: 99 },
  { text: "Encantadora", time: 100 },
];
